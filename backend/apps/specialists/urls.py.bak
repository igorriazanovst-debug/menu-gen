...
urlpatterns = [
    ...
    path("cabinet/clients/<int:family_id>/menus/<int:menu_id>/", CabinetClientMenuDetailView.as_view(), name="cabinet-client-menu-detail"),
    path("cabinet/clients/<int:family_id>/menus/<int:menu_id>/items/<int:item_id>/", CabinetMenuItemSwapView.as_view(), name="cabinet-menu-item-swap"),

    # Рекомендации
    path("cabinet/clients/<int:family_id>/recommendations/", CabinetRecommendationListView.as_view(), name="cabinet-recommendations"),
    path("cabinet/clients/<int:family_id>/recommendations/<int:rec_id>/", CabinetRecommendationDetailView.as_view(), name="cabinet-recommendation-detail"),
]
