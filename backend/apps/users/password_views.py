...
from .password_reset import read_token, send_reset_email


class PasswordResetRequestView(APIView):
    """POST /auth/password-reset/request/ {email} — письмо со ссылкой.
    ...
    кому угодно без входа. Ровно как в форме удаления аккаунта.
    """
