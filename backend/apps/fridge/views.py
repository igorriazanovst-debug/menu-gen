...
class FridgeItemConsumeView(APIView):
    ...
    пачку и говорит, сколько из НЕЁ ушло. Перевод в граммы (MG_UNITNORM) нужен
    только там, где сходятся две разные правды — рецепт и холодильник; здесь
    правда одна.
