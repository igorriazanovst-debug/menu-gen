...
и говорит, сколько ушло из НЕЁ. Никаких переводов единиц — и это не упрощение,
а обход ямы из BACKLOG T-36: перевести штуки и упаковки в граммы всё равно
нечем.
...
class TestИзрасходовал:
    ...
    def test_единица_позиции_сохраняется(self, owner, family):
        """Яйца лежат в штуках — в штуках и списываются, без перевода в граммы."""
