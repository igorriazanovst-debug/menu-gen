...
CELERY_BEAT_SCHEDULE = {
    ...
    #
    # 3:40, а не 3:15: не наступать на очистку карантина меню. Время местное
    # (django_celery_beat берёт TIME_ZONE проекта), то есть 3:40 по Москве —
    # проверено на деве, расписание показывается как «40 3 * * * Europe/Moscow».
