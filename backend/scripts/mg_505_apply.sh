...
docker compose -f "$COMPOSE_FILE" exec -T web python manage.py makemigrations menu --name mg_505_menuitem_cheat_meal
...
# --- 10. Run tests ---
echo "Run tests"
docker compose -f "$COMPOSE_FILE" exec -T web pytest apps/menu/tests/test_mg_505.py -v
echo
