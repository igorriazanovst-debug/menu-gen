...
//
// Экран закрытой части: открывается из профиля, доступен только после входа
// в аккаунт (см. редирект в app_router).
//
// Бэкенд отдаёт все три документа одним объектом, поэтому список грузит его
// один раз и передаёт дальше через extra — экран документа не делает повторный
// запрос.
