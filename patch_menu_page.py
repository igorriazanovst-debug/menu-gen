#!/usr/bin/env python3
"""
Патч web/menugen-web/src/pages/Menu/MenuPage.tsx:
1. Выбор 3/5 приёмов пищи в форме генерации
2. Режим редактирования — кнопка «Редактировать» / «Просмотр»
3. Клик на карточку приёма пищи → модал с рецептами, печатью
"""
import pathlib

TSX = pathlib.Path("/opt/menugen/web/menugen-web/src/pages/Menu/MenuPage.tsx")

NEW_TSX = r"""import React, { useState, useEffect, useCallback, useRef } from 'react';
...
print(f"✓ {TSX}")
print("\nПерезапусти React (если нужно):")
print("  cd /opt/menugen && docker compose restart frontend  # или просто сохрани — hot reload")
