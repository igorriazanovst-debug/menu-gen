...
### T-26 — переключение активной семьи · severity: medium · 🟡 IN_PROGRESS (MG_ACTIVEFAMILY, chat-84) — сервер готов, клиенты нет
...
Осталось (клиенты): переключатель в приложении и в вебе + сброс состояния меню,
холодильника, покупок и дневника при переключении — иначе на экране останутся
данные прошлой семьи.
...
### T-27 — приглашение в семью без согласия приглашаемого · severity: medium · 🟡 IN_PROGRESS (MG_FAMINVITE, chat-84) — сервер готов, клиенты нет
...
Осталось (клиенты): экран входящих приглашений с «принять/отклонить» и показ
приглашённых-но-не-ответивших в списке участников.
