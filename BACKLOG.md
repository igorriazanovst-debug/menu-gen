...
### T-26 — переключение активной семьи · severity: medium · OPEN (chat-84)
...
Патч: поле «активная семья» у пользователя + ручка переключения + общий резолвер
из T-25 читает его; переключатель в приложении и в вебе; при исключении из семьи
активная молча возвращается на свою (иначе человек остаётся с указателем на
семью без доступа и получает ошибку на каждом экране); после переключения
сбросить состояние меню, холодильника, покупок и дневника разом — иначе на
экране останутся данные прошлой семьи.
...
### T-27 — приглашение в семью без согласия приглашаемого · severity: medium · OPEN (chat-84)
