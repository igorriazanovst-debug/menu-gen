...
**Что осталось на будущее — салаты.** Пул 57 при потребности 56: формально «ок»,
но ровно в норматив и без запаса, поэтому верхние салаты появляются в 40–55 %
меню и занимают десять строк из пятнадцати в топе повторяемости. Материал
готов: в остатке say7 лежат 150 салатов с весом порции и калориями, которым
нужны только фотографии. Заводить отдельной задачей, когда дойдут руки; на
работу приложения текущее состояние не влияет — анализатор говорит «норма».
