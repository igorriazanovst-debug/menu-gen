...
### T-36 — штуки и упаковки не сходятся с граммами · severity: medium · OPEN
...
Чинить надо один раз на обоих концах: завести у продукта вес штуки (и объём
упаковки), заполнить для ходовых позиций и учитывать в обеих функциях.
Заполнение — отдельная работа с данными, и без неё код ничего не изменит.
