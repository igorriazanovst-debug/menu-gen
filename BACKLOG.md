...
**Чем это закрывается (состояние после чистки T-23).** В остатке say7 лежат
готовые к публикации рецепты, которым не хватает только фотографии: супов 10,
перекусов 72, салатов 150, десертов 136, выпечки 254, основных 416. То есть
**тридцать пять фотографий закрывают задачу целиком** — девять супов и двадцать
шесть перекусов. По супам запаса нет: их ровно десять, снимать надо все.
