...
### T-22 — s1: запрет сахара в основных приёмах убивал десертный слот · severity: medium · ✅ ИСПРАВЛЕНО, ждёт замера (chat-83)
...
Осталось: выкатить на прод и перемерить там — на dev пулы другие (салатов 24
против 57), и переносить сюда продовые ожидания нельзя.
...
не встречается. Та же беда у десертов (5 из 45). До выкатки правки
из T-21 цифры пулов в этой таблице завышены для выпечки и десертов (реально
доступны 2 и 5), а по остальным ролям верны — недостижимых там 0–5.
